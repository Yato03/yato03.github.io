...
<img src="/public/image/pg-spx/home.png" alt="home">
<br/>
...
<img src="/public/image/pg-spx/phpinfo.png" alt="phpinfo">
<br/>
...
<img src="/public/image/pg-spx/php-spx-github.png" alt="phpspx-github">
<br/>

Por defecto, el secreto es `dev` pero usaremos el secreto que robamos del `phpinfo`:

<img src="/public/image/pg-spx/spx-dashbaord.png" alt="phpspx-dasboard">
<br/>
...
<img src="/public/image/pg-spx/exploit-modified.png" alt="exploit-modification">
<br/>
...
```
<br/>
<img src="/public/image/pg-spx/lfi-etc-passwd.png" alt="exploit-lfi">
<br/>
...
<img src="/public/image/pg-spx/tiny-file-manager-config-github.png" alt="config-tiny">
<br/>

2. El archivo oficial puede tener otro nombre:
<img src="/public/image/pg-spx/changing-name.png" alt="name-tiny">
<br/>
...
<img src="/public/image/pg-spx/password-hashes.png" alt="password-hashes">
<br/>
...
<img src="/public/image/pg-spx/hashcat.png" alt="hashcat">
<br/>
...
<img src="/public/image/pg-spx/admin-access.png" alt="access">
<br/>
...
<img src="/public/image/pg-spx/revshells.png" alt="revshells">
<br/>

Como resultado, da un archivo el cual llamé `monkey.php` listo para subir.

<img src="/public/image/pg-spx/tiny-file-manager-upload.png" alt="upload-tiny">
<br/>

Al ponerme en escucha y al entrar a la página web `/monkey.php` obtuve la reverse shell:

<img src="/public/image/pg-spx/reverseShell.png" alt="reverse-shell">
<br/>
...
<img src="/public/image/pg-spx/users_found.png" alt="users">
<br/>
...
<img src="/public/image/pg-spx/local-flag.png" alt="local-flag">
<br/>

Enumerando los permisos del usuario `profiler`:

<img src="/public/image/pg-spx/sudo-l.png" alt="sudo-l">
<br/>
...
<img src="/public/image/pg-spx/new-makefile.png" alt="new-makefile">
<br/>

Podemos encontrar la flag en `/root/proof.txt`:
<img src="/public/image/pg-spx/proof-flag.png" alt="proof-flag">
<br/>
